function personal_account(){
    alert("Благодарим, Вы успешно зарегистрировались!");
    setTimeout(function(){
        window.location.href = 'Personal_accout_page.html'; // Переход на страницу личного кабинета
      }, 1 * 1000); // Интервал перехода на страницу
};

function personal_account_log(){
    alert("Добро пожаловать, мы рады Вас видеть!");
    setTimeout(function(){
        window.location.href = 'Personal_accout_page.html'; 
      }, 1 * 1000);
};
