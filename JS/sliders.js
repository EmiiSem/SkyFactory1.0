class Slider {
    constructor(slider, autoplay = true) {
        ...
        // цепочка кадров
        this.frameChain = slider.querySelector('.slider');
        // кнопка «вперед»
    ...
    init() {
        ...
        // от ширины контейнера .slider, то есть 900 пикселей
        this.allFrames.forEach(frame => frame.style.width = 95.1/this.length + '%');    // 93.7 было!
        ...
        this.frameChain.style.width = 100 * this.length + '%';                          // 100 было!
